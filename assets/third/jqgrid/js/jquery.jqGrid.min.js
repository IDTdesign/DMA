                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                        ...
                        var r = function(a, b) {
                            ...
                            return isNaN(a) ? b || 0 : a
                                ...
                                e = '<div><input role="checkbox" type="checkbox" id="jqg_' + a.p.id + "_" + b + '" class="cbox po" name="jqg_' +
                                    a.p.id + "_" + b + '"' + (e ? 'checked="checked"' : "") + "/><label class=\"choise\"></label></div>";
                            ...
                            Q = function(c) {
                                ...
                                if ("desc" === f[c].lso) f[c].lso += "-asc", l = "asc";
                                else {
                        ...
                        b(a).before(c.hDiv).click(function(c) {
                            ...
                            if (a.p.multikey) c[a.p.multikey] ? b(a).jqGrid("setSelection", B, !0, c) : a.p.multiselect && d && (d = b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + B).is(":checked"), b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + B)[a.p.useProp ? "prop" : "attr"]("checked", d));
                            else {
            ...
            f && (b.isArray(f) ? (x = !0, c = "last", G = e) : (f = [f], x = !1), this.each(function() {
                ...
                for (var O = 0, $ = "", K = {}, Y = b.isFunction(this.p.afterInsertRow) ? !0 : !1; O < X;) {
                    ...
                    n && (q = this.formatCol(0, 1, "", null, e, !0), g[g.length] = '<td role="gridcell" class="ui-state-default jqgrid-rownum" ' +
                        q + ">0</td>");
                    h && (p = '<div><input role="checkbox" type="checkbox" id="jqg_' + this.p.id + "_" + e + '" class="cbox"/><label class="choise"></label></div>', q = this.formatCol(n, 1, "", null, e, !0), g[g.length] = '<td role="gridcell" ' + q + ">" + p + "</td>");
    ...
    toObj: function(a) {
        ...
        if (1 === a.nodeType) {
            ...
            if (a.firstChild) {
                ...
                if (f) a.attributes.length ? b["#text"] =
