                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                        ...
                        var r = function(a, b) {
                            ...
                            return isNaN(a) ? b || 0 : a
                                ...
                                e = '<input role="checkbox" type="checkbox" id="jqg_' + a.p.id + "_" + b + '" class="cbox po" name="jqg_' +
                                    a.p.id + "_" + b + '"' + (e ? 'checked="checked"' : "") + "/><label class=\"choise\"></label>";
            ...
            f && (b.isArray(f) ? (x = !0, c = "last", G = e) : (f = [f], x = !1), this.each(function() {
                ...
                for (var O = 0, $ = "", K = {}, Y = b.isFunction(this.p.afterInsertRow) ? !0 : !1; O < X;) {
                    ...
                    n && (q = this.formatCol(0, 1, "", null, e, !0), g[g.length] = '<td role="gridcell" class="ui-state-default jqgrid-rownum" ' +
                        q + ">0</td>");
                    h && (p = '<input role="checkbox" type="checkbox" id="jqg_' + this.p.id + "_" + e + '" class="cbox"/><label class="choise"></label>', q = this.formatCol(n, 1, "", null, e, !0), g[g.length] = '<td role="gridcell" ' + q + ">" + p + "</td>");
